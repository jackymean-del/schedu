    ...
    <div style={{ minHeight: '100vh', background: '#F5F2FF' }}>
      ...
      <div style={{ maxWidth: 820, margin: '0 auto', padding: '24px 28px', display: 'flex', flexDirection: 'column', gap: 20 }}>
        ...
        <section style={{ background: '#fff', border: '1px solid #ECE9FB', borderRadius: 14, padding: 20 }}>
          ...
          <p style={{ fontSize: 12.5, color: '#8B87AD', margin: '0 0 14px' }}>
            {members.length === 0
            ...
            return (
              <div key={m.id} style={{
                ...
                <div style={{ flex: 1, minWidth: 0 }}>
                  ...
                  <div style={{ fontSize: 12, color: '#8B87AD', overflow: 'hidden', textOverflow: 'ellipsis' }}>{m.email}</div>
                </div>
                ...
                {canManage ? (
                  <select
                    ...
                    style={{
                      ...
                      color: lastAdmin ? '#9A95BC' : style.fg,
          ...
          {members.length > 0 && (
            <div style={{ marginTop: 12, paddingTop: 11, borderTop: '1px solid #F3F1FB', fontSize: 11.5, color: '#9A95BC', display: 'flex', gap: 7, alignItems: 'flex-start' }}>
              <ShieldCheck size={13} color="#9A95BC" style={{ flexShrink: 0, marginTop: 1 }} />
        ...
        {canManage && (
          <section style={{ background: '#fff', border: '1px solid #ECE9FB', borderRadius: 14, padding: 20 }}>
            ...
            <div style={{ fontSize: 11.5, color: '#9A95BC', marginTop: 9 }}>{ROLE_HINTS[role]}</div>
          </section>
        )}
      </div>
    </div>
