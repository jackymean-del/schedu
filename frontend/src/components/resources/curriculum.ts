...
export const CURRICULUM: Record<string, SubjectRule> = {
  ...
  'English': {
    ...
    isLanguage: true,
    slots:           { preK: 4, primary: 6, middle: 6, secondary: 5, srSec: 5 },
    icseSlots:       { preK: 5, primary: 7, middle: 7, secondary: 6, srSec: 6 },
    ibSlots:         { preK: 5, primary: 7, middle: 6, secondary: 6, srSec: 6 },
    cambridgeSlots:  { preK: 5, primary: 7, middle: 7, secondary: 6, srSec: 6 },
    hint: 'Core language — mandatory at every grade level across all boards',
  },
  'Physical Education': {
    grades: ['preK','primary','middle','secondary','srSec'],
    isActivity: true,
    slots:    { preK: 3, primary: 2, middle: 2, secondary: 2, srSec: 2 },
    ibSlots:  { preK: 4, primary: 3, middle: 3, secondary: 3, srSec: 3 },
  ...
  'Environmental Studies': {
    grades: ['preK','primary'],
    slots: { preK: 3, primary: 4 },
    hint: 'Same as EVS — applicable Nursery through Class V only',
  },
  ...
  'Computer Science': {
    ...
    slots:    { primary: 2, middle: 3, secondary: 3, srSec: 4 },
  ...
  'Physics': {
    ...
    hint: 'Physics — CBSE: part of unified Science IX–X; standalone at XI–XII; requires lab',
  },
  'Chemistry': {
    grades: ['secondary','srSec'],
    requiresLab: true,
    ...
    ibSlots:         { secondary: 5, srSec: 5 },
    cambridgeSlots:  { secondary: 5, srSec: 6 },
    hint: 'Chemistry — CBSE: part of unified Science IX–X; standalone at XI–XII; requires lab',
  },
  'Biology': {
    grades: ['secondary','srSec'],
    requiresLab: true,
    ...
    hint: 'Biology — CBSE: part of unified Science IX–X; standalone for PCB stream at XI–XII; requires lab',
  },
  'Biotechnology': {
    grades: ['srSec'],
    streams: ['science'],
  ...
  'History': {
    ...
    hint: 'History — part of SST in CBSE IX–X; standalone Arts/Humanities subject at XI–XII',
  },
  'Geography': {
    grades: ['secondary','srSec'],
    slots:     { secondary: 3, srSec: 5 },
    icseSlots: { secondary: 4, srSec: 5 },
    hint: 'Geography — part of SST in CBSE IX–X; standalone Arts/Humanities subject at XI–XII',
  },
  'Political Science': {
    grades: ['secondary','srSec'],
    slots:     { secondary: 2, srSec: 5 },
    icseSlots: { secondary: 3, srSec: 5 },
    hint: 'Political Science / Civics — part of SST in CBSE; Arts/Humanities stream at XI–XII',
  },
  'Economics': {
    grades: ['secondary','srSec'],
    slots: { secondary: 3, srSec: 5 },
    hint: 'Economics — introduced in Class IX–X; core Commerce + Arts subject at XI–XII',
  },
  ...
  'Accountancy': {
    ...
    streams: ['commerce'],
    slots: { srSec: 5 },
    hint: 'Accountancy — Commerce stream core subject at XI–XII',
  },
  'Business Studies': {
    grades: ['srSec'],
    streams: ['commerce'],
    slots: { srSec: 5 },
    hint: 'Business Studies — Commerce stream core subject at XI–XII',
  },
  'Entrepreneurship': {
    grades: ['srSec'],
    streams: ['commerce','arts','general'],
  ...
  'Psychology': {
    ...
    streams: ['arts','general'],
    slots: { srSec: 5 },
    hint: 'Psychology — Arts/Humanities elective at XI–XII',
  },
  'Sociology': {
    grades: ['srSec'],
    streams: ['arts','general'],
    slots: { srSec: 5 },
    hint: 'Sociology — Arts/Humanities elective at XI–XII',
  },
  'Philosophy': {
    grades: ['srSec'],
    streams: ['arts','general'],
