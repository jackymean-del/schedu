 ...
 * indicative rate table (no network call — safe for the static marketing build).
 * Unknown regions, or regions whose currency we don't have a rate for, simply
 * fall back to showing the real INR price.
 */
