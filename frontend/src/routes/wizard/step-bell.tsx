...
const CLASS_GROUPS = [
  { group: 'Pre-Primary',      desc: 'Nursery–UKG',   color: '#685DBC', bg: '#F5F3FF' },
...
const TYPE_META: Record<RowType, { label: string; bg: string; fg: string; border: string; line: string }> = {
  assembly:     { label: 'Assembly',    bg: '#EDE9FF', fg: '#685DBC', border: '#C4B5FD', line: '#685DBC' },
  ...
  return (
    <div style={{
      ...
      <div style={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between', marginBottom: 6 }}>
        <div>
          <div style={{ display: 'flex', alignItems: 'center', gap: 6, fontSize: 13, fontWeight: 700, color: '#685DBC', marginBottom: 4 }}>
        ...
        <button onClick={onClose} style={{
          ...
          color: '#6B7079', padding: 4, display: 'flex', flexShrink: 0, marginLeft: 10,
        }}>
          <X size={14} />
        </button>
      </div>
      ...
      <div style={{
        ...
        marginBottom: 14, fontSize: 11, color: '#69707E',
      }}>
      ...
      {cwRows.length > 0 && (
        <div style={{
          ...
          {['Break name', 'Applies to', 'Break timing', 'Duration', ''].map((h, i) => (
            <div key={i} style={{ fontSize: 10, fontWeight: 600, color: '#6B7079', letterSpacing: '0.05em' }}>{h}</div>
          ))}
        </div>
      )}
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: 8, marginBottom: 14 }}>
            ...
            <div key={row.id} style={{
              ...
              <div>
                ...
                {row.classes.length > 0 && row.classes.length < allClassKeys.length && (
                  <div style={{ fontSize: 10, color: '#6B7079', marginTop: 4 }}>
              ...
              <div>
                ...
                <select
                  ...
                  style={{
                    ...
                    background: '#F8F7FF', color: '#685DBC', fontWeight: 600,
                ...
                {row.customStartTime && (
                  <div style={{ display: 'flex', alignItems: 'center', gap: 4, marginBottom: 4 }}>
                    <input
                      ...
                      style={{ flex: 1, padding: '3px 5px', border: '1px solid #C4B5FD', borderRadius: 5, fontSize: 11, fontFamily: 'inherit', outline: 'none', background: '#F8F7FF', color: '#685DBC' }}
                    />
                    <span style={{ fontSize: 10, color: '#6B7079' }}>start</span>
                  </div>
                )}

                {/* Calculated time hint */}
                <div style={{ fontSize: 10, color: '#685DBC', fontFamily: "'DM Mono',monospace" }}>
              ...
              <div>
                <div style={{ display: 'flex', alignItems: 'center', gap: 3 }}>
                  ...
                  />
                  <span style={{ fontSize: 10, color: '#6B7079', whiteSpace: 'nowrap' }}>min</span>
                </div>
              </div>
        ...
        {cwRows.length === 0 && (
          <div style={{
            textAlign: 'center', padding: '20px 0', color: '#6B7079', fontSize: 12,
          }}>
      ...
      <button onClick={addRow} style={{
        ...
        color: '#685DBC', fontSize: 11, fontWeight: 600,
      ...
      <div style={{
        ...
        <button onClick={onGenerate} disabled={cwRows.length === 0} style={{
          ...
          background: cwRows.length > 0 ? '#685DBC' : '#E5E7EB',
          color: cwRows.length > 0 ? '#fff' : '#6B7079',
  ...
  return (
    <div ref={ref} style={{ position: 'relative', display: 'inline-block' }}>
      <button ref={btnRef} onClick={() => setOpenId(isOpen ? null : rowId)} style={{
        ...
        fontSize: 11, fontWeight: 600, color: isAll ? '#685DBC' : '#374151',
        ...
        <div style={{
          ...
          <label style={PICK_ROW}>
            <input type="checkbox" checked={isAll}
              ...
              style={{ accentColor: '#685DBC', flexShrink: 0 }} />
                          ...
                          return (
                            <label key={ck} style={{ ...PICK_ROW, paddingLeft: 44 }}>
                              ...
                              <span style={{
                                ...
                                color: checked ? (sd?.color ?? gm.color) : '#6B7079',
                              }}>{stream}</span>
                            </label>
                          )
                        })}
    ...
    return (
      <div style={{
        ...
        <div style={{
          ...
          <button onClick={() => { setMode('idle'); setBreakName('') }} style={{ background: 'none', border: 'none', cursor: 'pointer', color: '#6B7079', padding: 2, display: 'flex' }}><X size={10} /></button>
        </div>
      </div>
    )
  }
          ...
          <>
            ...
            <button className="gap-btn" onClick={() => onInsertSplit(afterIndex)}
              ...
              style={{
                ...
                color: '#685DBC', fontSize: 10, fontWeight: 600,
                cursor: 'pointer', fontFamily: 'inherit',
              }}>
        ...
        return (
          <div key={row.id + idx} style={{
            ...
            <div style={{ fontFamily: "'DM Mono',monospace", flexShrink: 0 }}>
              ...
              <div style={{ fontSize: 9, color: '#6B7079' }}>{fmt12(end, use12h)}</div>
            </div>
            <div style={{ flex: 1, minWidth: 0 }}>
              ...
              <div style={{ fontSize: 9, color: '#6B7079' }}>{row.duration} min · {grp}</div>
            </div>
          </div>
        )
      })}
...
export function StepBell() {
  ...
  useEffect(() => {
    ...
    const STREAM_COLORS = [
      { color: '#685DBC', bg: '#F0EDFF' }, { color: '#059669', bg: '#D1FAE5' },
  ...
  return (
    <div style={{ padding: '20px 28px 32px', maxWidth: 1280, margin: '0 auto', fontFamily: "'Plus Jakarta Sans', -apple-system, sans-serif" }}>
      <style>{`
        ...
        .b-input:focus { border-color:#685DBC;box-shadow:0 0 0 3px rgba(124,111,224,.10); }
        ...
        .b-cell:focus  { border-color:#685DBC;background:#fff;box-shadow:0 0 0 2px rgba(124,111,224,.08); }
        ...
        .b-dur:focus { border-color:#685DBC;background:#fff; }
        ...
        <div style={setupChoice === 'choose' ? { maxWidth: 560, margin: '40px auto 0' } : undefined}>
          ...
          {setupChoice === 'choose' ? (
            <div style={{ border: '1.5px solid #DDD6FE', background: 'linear-gradient(180deg,#FBFAFF,#F5F3FF)', borderRadius: 14, padding: '18px 20px', marginBottom: 20 }}>
                    ...
                    {([['one', 'One schedule for all', 'Same bells across every block'], ['per-block', 'Different timing per block', 'One shift per block — set each separately']] as const).map(([val, label, desc]) => {
                      ...
                      return (
                        <button key={val} onClick={() => setAreaMode(val)} style={{
                          ...
                          border: active ? '2px solid #685DBC' : '1.5px solid #E5E7EB', background: active ? '#F5F3FF' : '#fff',
                        }}>
                          <div style={{ fontSize: 12, fontWeight: 700, color: active ? '#6358C4' : '#374151' }}>{label}</div>
                          <div style={{ fontSize: 10, color: '#6B7079', marginTop: 2 }}>{desc}</div>
                        </button>
                      )
                    })}
                  </div>
              ...
              <div style={{ display: 'flex', gap: 10 }}>
                <button onClick={applyGuidedSetup} style={{ flex: 1, padding: '12px', borderRadius: 10, border: 'none', background: '#685DBC', color: '#fff', fontSize: 13, fontWeight: 700, cursor: 'pointer', fontFamily: 'inherit', boxShadow: '0 2px 8px rgba(124,111,224,0.3)' }}>
                  ✨ Build it for me
                ...
                <button onClick={() => setSetupChoice('manual')} style={{ flex: 1, padding: '12px', borderRadius: 10, border: '1.5px solid #E5E7EB', background: '#fff', color: '#374151', fontSize: 13, fontWeight: 700, cursor: 'pointer', fontFamily: 'inherit' }}>
                  ...
                  <div style={{ fontSize: 10, fontWeight: 500, color: '#6B7079', marginTop: 2 }}>Set hours, breaks &amp; periods yourself</div>
                </button>
              </div>

              <div style={{ fontSize: 10.5, color: '#6B7079', marginTop: 12, lineHeight: 1.5 }}>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 16, padding: '8px 12px', borderRadius: 10, border: '1px solid #EDE9FE', background: '#FBFAFF' }}>
              ...
              {distinctBlocks.length > 1 && <span style={{ fontSize: 11, color: '#6B7079' }}>· {areaMode === 'per-block' ? `${distinctBlocks.length} blocks` : 'one schedule'}</span>}
              <div style={{ flex: 1 }} />
              <button onClick={() => setSetupChoice('choose')} style={{ fontSize: 11, fontWeight: 700, color: '#685DBC', background: 'none', border: 'none', cursor: 'pointer', fontFamily: 'inherit' }}>Change</button>
            </div>
          )}
              ...
              {(['standard', 'advanced'] as const).map(mode => {
                ...
                return (
                  <button key={mode} onClick={() => handleSetMode(mode)} style={{
                    ...
                    {mode === 'advanced' && (
                      <span style={{ fontSize: 9, fontWeight: 800, letterSpacing: '0.04em', color: '#685DBC', background: '#EDE9FF', padding: '2px 6px', borderRadius: 6 }}>HYBRID</span>
                    )}
                  </button>
                )
              })}
            ...
            <div style={{ background: '#fff', borderRadius: 10, border: '1px solid #E5E7EB', overflow: 'hidden' }}>
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: 7, padding: '10px 16px', background: '#FAFAFA', borderBottom: '1px solid #F3F4F6' }}>
                ...
                <span style={{
                  ...
                  borderRadius: 10, background: '#EDE9FF', color: '#685DBC', letterSpacing: '0.03em',
                }}>
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: 14, flexWrap: 'wrap' }}>
                {!useDayNames && (
                  <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
                    <span style={{ fontSize: 12, color: '#69707E' }}>Repeats every</span>
                    {/* Stepper */}
                    <div style={{ display: 'inline-flex', alignItems: 'center', border: '1.5px solid #E5E7EB', borderRadius: 8, overflow: 'hidden' }}>
                      ...
                      }} style={{ padding: '5px 11px', background: 'none', border: 'none', fontSize: 15, fontWeight: 700, color: cycleWeeks <= 1 ? '#D1D5DB' : '#685DBC', cursor: cycleWeeks <= 1 ? 'default' : 'pointer', fontFamily: 'inherit' }}>−</button>
                      ...
                      <button onClick={() => setCycleWeeks(w => Math.min(12, w + 1))}
                        style={{ padding: '5px 11px', background: 'none', border: 'none', fontSize: 15, fontWeight: 700, color: '#685DBC', cursor: 'pointer', fontFamily: 'inherit' }}>+</button>
                    </div>
                    <span style={{ fontSize: 12, color: '#69707E' }}>{cycleWeeks === 1 ? 'week' : 'weeks'}</span>
                  </div>
                )}
                ...
                <label style={{ display: 'flex', alignItems: 'center', gap: 8, cursor: 'pointer', marginLeft: useDayNames ? 0 : 'auto', userSelect: 'none' }}>
                  <div style={{ position: 'relative', width: 34, height: 18, flexShrink: 0 }}>
                    ...
                    <div style={{ position: 'absolute', inset: 0, borderRadius: 9, background: useDayNames ? '#685DBC' : '#E5E7EB', transition: 'background .2s' }} />
                  ...
                  <span style={{ fontSize: 12, color: '#374151' }}>Use day names <span style={{ color: '#6B7079' }}>(A/B, 8-day…)</span></span>
                </label>
              </div>
              ...
              {(cycleWeeks > 1 || useDayNames) && (
                <div style={{ marginTop: 14 }}>
                  <div style={{ fontSize: 12, color: '#69707E', marginBottom: 6 }}>
                  ...
                  <div style={{ display: 'flex', alignItems: 'center', gap: 10, flexWrap: 'wrap' }}>
                    ...
                    {cycleStartDate && (
                      <div style={{ display: 'flex', alignItems: 'center', gap: 6, padding: '6px 12px', borderRadius: 7, background: '#F0FDF4', border: '1px solid #BBF7D0' }}>
                        ...
                        <span style={{ fontSize: 11, color: '#0A8136', fontWeight: 600 }}>
                          {useDayNames ? 'Rotation' : 'Week 1'} starts on {cycleStartHint(cycleStartDate)}
                        </span>
                        <button onClick={() => setCycleStartDate('')}
                          style={{ background: 'none', border: 'none', cursor: 'pointer', color: '#6B7079', fontSize: 11, padding: 0, fontFamily: 'inherit' }}>Clear</button>
                      </div>
                    )}
                  </div>
                      ...
                      {Array.from({ length: cycleWeeks }, (_, i) => {
                        ...
                        return (
                          <div key={w} style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 8, flexWrap: 'wrap' }}>
                            <span style={{
                              fontSize: 11, fontWeight: 800, color: isCustom ? '#685DBC' : '#6B7079',
                              ...
                              {ALL_DAYS.map(d => {
                                ...
                                return (
                                  <button key={d} onClick={() => {
                                    ...
                                    border: on ? '1px solid #685DBC' : '1px solid #E5E7EB',
                                    background: on ? '#EDE9FF' : '#fff',
                                    color: on ? '#685DBC' : '#D1D5DB',
                            ...
                            {isCustom && (
                              <button onClick={() => setWeekWorkDays(prev => {
                                ...
                                fontSize: 10, color: '#6B7079', background: 'none', border: 'none',
              ...
              {useDayNames && (
                <div style={{ marginTop: 14 }}>
                  <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 8 }}>
                    ...
                    <span style={{ fontSize: 11, fontWeight: 700, color: '#685DBC' }}>{rotationDays.length} days in rotation</span>
                  </div>
                  <div style={{ display: 'grid', gridTemplateColumns: '14px 1fr 56px 20px', gap: '6px 10px', alignItems: 'center', marginBottom: 4 }}>
                    <span />
                    <span style={{ fontSize: 10, fontWeight: 700, color: '#6B7079', letterSpacing: '0.06em' }}>FULL NAME</span>
                    <span style={{ fontSize: 10, fontWeight: 700, color: '#6B7079', letterSpacing: '0.06em' }}>SHORT</span>
                    <span />
                  </div>
                  {rotationDays.map((day, i) => (
                    <div key={i} style={{ display: 'grid', gridTemplateColumns: '14px 1fr 56px 20px', gap: '6px 10px', alignItems: 'center', marginBottom: 6 }}>
                      <span style={{ fontSize: 11, color: '#6B7079', textAlign: 'right' }}>{i + 1}.</span>
                  ...
                  {rotationDays.length < 20 && (
                    ...
                    }} style={{ display: 'inline-flex', alignItems: 'center', gap: 5, marginTop: 2, background: 'none', border: 'none', cursor: 'pointer', color: '#685DBC', fontSize: 12, fontWeight: 600, fontFamily: 'inherit', padding: 0 }}>
          ...
          <div style={{ marginBottom: 16 }}>
            <div style={{ background: '#fff', borderRadius: 10, border: '1px solid #E5E7EB', overflow: 'hidden' }}>
              ...
              <div style={{ fontSize: 11, color: '#6D6A8A', marginBottom: 10, lineHeight: 1.5 }}>
                    ...
                    {(['range', 'fixed'] as const).map(m => (
                      <button key={m} type="button"
                        ...
                        style={{
                          ...
                          background: periodDurationMode === m ? '#685DBC' : '#fff',
                          color: periodDurationMode === m ? '#fff' : '#69707E',
                        }}>
                        {m === 'fixed' ? 'Fixed' : 'Range'}
                      </button>
                    ))}
                  ...
                  <div style={{ ...FL, display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                    ...
                    {!maxPeriodsAuto && (
                      <span onClick={() => { setMaxPeriodsAuto(true); recomputeAutoMaxPeriods() }}
                        ...
                        style={{ color: '#685DBC', cursor: 'pointer', fontWeight: 700, fontSize: 9.5 }}>
                        ↺ Auto
                      </span>
                    )}
                  </div>
              ...
              {activeClassGroups.length > 0 && (() => {
                ...
                return (
                  <div style={{ marginBottom: 14 }}>
                    <div style={{ fontSize: 11, fontWeight: 700, color: '#69707E', letterSpacing: '0.06em', textTransform: 'uppercase', marginBottom: 6 }}>
                            ...
                            <div key={gk} style={{ display: 'flex', alignItems: 'center', gap: 8,
                              ...
                              <div style={{ flex: 1, minWidth: 0 }}>
                                <div style={{ fontSize: 11, fontWeight: 700, color: '#374151' }}>
                                  {s.label}
                                  <span style={{ fontWeight: 400, color: '#6B7079', marginLeft: 5 }}>({s.ages})</span>
                                </div>
                                <div style={{ fontSize: 10, color: '#69707E' }}>
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: 8, flexWrap: 'wrap' }}>
                {cycleWeeks === 1 && !useDayNames && (
                  <>
                    <span style={{ fontSize: 12, color: '#69707E', flexShrink: 0 }}>Working days:</span>
                    {ALL_DAYS.map(d => {
                  ...
                  {daySuggestions.map(sug => (
                    <div key={sug.id} style={{
                      ...
                      <div style={{ flex: 1, minWidth: 0 }}>
                        ...
                        <p style={{ fontSize: 11, color: '#69707E', margin: '0 0 9px', lineHeight: 1.6 }}>
                          {sug.detail}
                        </p>
                        <button
                        ...
                        {rule.classes.length > 0 && rule.classes.length < activeClassKeys.length && (
                          <div style={{ display: 'flex', flexWrap: 'wrap', gap: 3 }}>
                            ...
                            {rule.classes.length > 6 && (
                              <span style={{ fontSize: 10, color: '#6B7079', alignSelf: 'center' }}>
            ...
            <div style={{ background: '#fff', borderRadius: 10, border: '1px solid #E5E7EB', overflow: 'hidden' }}>
              ...
              <div style={{ display: 'flex', gap: 5, flexWrap: 'wrap', alignItems: 'center', padding: '8px 14px', background: '#FAFAFA', borderBottom: '1px solid #F3F4F6' }}>
                {shifts.map(s => {
                  ...
                  return (
                    <button key={s.id} onClick={() => setActiveShiftId(s.id)} style={{
                      ...
                      border: active ? '1.5px solid #685DBC' : '1px solid #E5E7EB',
                      background: active ? '#EDE9FF' : '#fff',
                      color: active ? '#685DBC' : '#6B7079',
                      cursor: 'pointer', fontFamily: 'inherit', transition: 'all .12s',
                    }}>
                      {s.name}
                      {shifts.length > 1 && (
                ...
                <button onClick={addShift} title="Add Shift" style={{
                  ...
                  color: '#685DBC', fontSize: 16, fontWeight: 700, lineHeight: 1,
                  display: 'inline-flex', alignItems: 'center', justifyContent: 'center',
                  cursor: 'pointer', fontFamily: 'inherit', transition: 'all .15s',
                }}>+</button>
              ...
              <div style={{ borderTop: '1px solid #F3F4F6', paddingTop: 14 }}>
                <div style={{ display: 'flex', alignItems: 'center', gap: 8, flexWrap: 'wrap' }}>
                  <span style={{ fontSize: 12, color: '#69707E', flexShrink: 0 }}>Assigned to:</span>
                  {/* All toggle */}
                  <button onClick={() => {
                    ...
                    color: activeClassKeys.every(k => activeShift.classes.includes(k)) ? '#fff' : '#6B7079',
                    cursor: 'pointer', fontFamily: 'inherit', transition: 'all .12s',
                  }}>All</button>
                  {/* Group toggles */}
                  {activeClassGroups.map(gm => {
                    ...
                    return (
                      ...
                      style={{
                        ...
                        color: on ? gm.color : (partial || someTaken) ? gm.color : '#6B7079',
                        cursor: 'pointer', fontFamily: 'inherit', transition: 'all .12s',
                      }}>
                        {gm.group}
                        ...
                        return (
                          <button key={cls.key} disabled={disabled}
                            ...
                            onClick={() => {
                              ...
                              background: on ? gm.bg : '#fff',
                              color: on ? gm.color : disabled ? '#D1D5DB' : '#6B7079',
                    ...
                    {daySuggestions.map(sug => (
                      <div key={sug.id} style={{
                        ...
                        <div style={{ flex: 1, minWidth: 0 }}>
                          ...
                          <p style={{ fontSize: 11, color: '#69707E', margin: '0 0 9px', lineHeight: 1.6 }}>{sug.detail}</p>
          ...
          <div style={{ marginBottom: 16 }}>
            <div style={{
              ...
              <div style={{
                ...
                <Sparkles size={14} color={autoBellMode ? '#685DBC' : '#6B7079'} />
                <span style={{ fontSize: 13, fontWeight: 700, color: autoBellMode ? '#6358C4' : '#69707E', flex: 1 }}>
                  Smart Timing
                </span>
                {/* Toggle */}
                <button
                  ...
                  style={{
                    ...
                    background: autoBellMode ? '#685DBC' : '#D1D5DB',
                ...
                <div style={{ padding: '14px 16px', display: 'flex', flexDirection: 'column', gap: 14 }}>
                      ...
                      {([['day', '🍱 Day-boarding', 'Near-uniform day for all ages'], ['normal', '🏃 Regular', 'Juniors finish earlier']] as const).map(([val, label, desc]) => {
                        ...
                        return (
                          <button key={val} onClick={() => { setDayboarding(val === 'day'); setBellCustomized(false) }} style={{
                            ...
                            border: active ? '2px solid #685DBC' : '1.5px solid #E5E7EB', background: active ? '#fff' : '#FAFAFA',
                          }}>
                            <div style={{ fontSize: 12, fontWeight: 700, color: active ? '#6358C4' : '#374151' }}>{label}</div>
                            <div style={{ fontSize: 10, color: '#6B7079', marginTop: 2 }}>{desc}</div>
                          </button>
                    ...
                    <div style={{ display: 'flex', gap: 8, marginTop: 10 }}>
                      ...
                      <button
                        ...
                        style={{
                          ...
                          border: !morningBreak ? '2px solid #6B7079' : '1.5px solid #E5E7EB',
                        ...
                        <span style={{ fontSize: 13 }}>✗</span>
                        <span style={{ fontSize: 11, fontWeight: 700, color: !morningBreak ? '#374151' : '#6B7079' }}>No break</span>
                        {!morningBreak && <div style={{ width: 6, height: 6, borderRadius: '50%', background: '#69707E', marginLeft: 2 }} />}
                      </button>
                      ...
                      <button
                        ...
                        <span style={{ fontSize: 13 }}>☕</span>
                        <span style={{ fontSize: 11, fontWeight: 700, color: morningBreak ? '#92400E' : '#6B7079' }}>
                            ...
                            {positions.map(({ pos, label, sub }) => {
                              ...
                              return (
                                <button key={pos}
                                  ...
                                  <span style={{ fontSize: 11, fontWeight: 700, color: active ? '#92400E' : '#69707E' }}>{label}</span>
                                  {sub && <span style={{ fontSize: 9, color: active ? '#B45309' : '#6B7079', marginTop: 1 }}>{sub}</span>}
                                </button>
                              )
                            })}
                          </div>
                        ...
                        <div style={{ background: '#fff', border: '1px solid #FDE68A', borderRadius: 8, padding: 10 }}>
                          ...
                          <div style={{ display: 'flex', gap: 8 }}>
                            ...
                            <button onClick={() => setAddingBreak(false)}
                              style={{ padding: '7px 12px', borderRadius: 7, border: '1px solid #E5E7EB', background: '#fff', color: '#69707E', fontWeight: 600, fontSize: 11, cursor: 'pointer', fontFamily: 'inherit' }}>
                              Cancel
                            </button>
                          </div>
                        </div>
                        ...
                        return (
                          <button key={mode}
                            ...
                            style={{
                              ...
                              border: active ? `2px solid ${isSmart ? '#685DBC' : '#69707E'}` : '1.5px solid #E5E7EB',
                            ...
                            <div style={{ fontSize: 12, fontWeight: 700, color: active ? (isSmart ? '#6358C4' : '#111827') : '#69707E', marginBottom: 3 }}>
                              {isSmart ? 'Smart Lunch' : 'Single Lunch'}
                            </div>
                            <div style={{ fontSize: 10, color: '#6B7079', lineHeight: 1.5 }}>
                              {isSmart
                                ? 'Each age group eats at a different time. Avoids canteen rush.'
                                : 'All classes share one common lunch break slot.'}
                            </div>
                            {active && (
                              <div style={{ width: 8, height: 8, borderRadius: '50%', background: isSmart ? '#685DBC' : '#374151', marginTop: 6 }} />
                            )}
                          </button>
                        )
                      })}
                  ...
                  {smartLunchMode === 'smart' && (
                    <div style={{
                        ...
                        {(() => {
                          ...
                          return (
                            <div key={gm.group} style={{
                              ...
                              <span style={{ fontSize: 10, color: '#6B7079', flex: 1 }}>{gm.desc}</span>
                              <span style={{ fontSize: 10, color: '#6B7079', minWidth: 80 }}>≈ {approx}</span>
                              <span style={{ fontSize: 11, color: '#69707E' }}>After P</span>
                              {/* − / value / + stepper */}
                              <div style={{ display: 'flex', alignItems: 'center', gap: 3 }}>
                                <button
                      ...
                      {/* Canteen tip */}
                      <div style={{ marginTop: 10, fontSize: 10, color: '#6B7079', display: 'flex', gap: 5, alignItems: 'flex-start' }}>
                        <span style={{ flexShrink: 0 }}>💡</span>
                  ...
                  {smartLunchMode === 'smart' && (
                    <div style={{
                      ...
                      <div style={{ fontSize: 10, color: '#69707E', marginBottom: 10, lineHeight: 1.6 }}>
                        ...
                        {([
                          ...
                          return (
                            <button key={opt.val}
                              ...
                              <div style={{ fontSize: 11, fontWeight: 700, color: active ? '#065F46' : '#69707E' }}>{opt.label}</div>
                              {opt.sub && <div style={{ fontSize: 9, color: active ? '#059669' : '#6B7079', marginTop: 2 }}>{opt.sub}</div>}
                      ...
                      {concurrentMode === 'match-lunch' && (
                        <div style={{ marginTop: 10 }}>
                          <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 6 }}>
                            ...
                            <span style={{ fontSize: 10, color: '#6B7079' }}>15–60 min</span>
                          </div>
          ...
          <div>
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
                ...
                {autoBellMode && (
                  <button
                    ...
                    onClick={() => runAutoGen()}
                    style={{
                      fontSize: 11, fontWeight: 700, color: '#685DBC',
                ...
                <label style={{ display: 'flex', alignItems: 'center', gap: 6, cursor: 'pointer', userSelect: 'none' }}>
                  <div style={{ position: 'relative', width: 30, height: 16, flexShrink: 0 }}>
                    <input type="checkbox" checked={varyByDay}
                      ...
                      style={{ opacity: 0, width: 0, height: 0, position: 'absolute' }} />
                    <div style={{ position: 'absolute', inset: 0, borderRadius: 8, background: varyByDay ? '#685DBC' : '#E5E7EB', transition: 'background .2s' }} />
                  ...
                  <span style={{ fontSize: 11, fontWeight: 600, color: varyByDay ? '#685DBC' : '#6B7079', transition: 'color .15s' }}>
                ...
                <button
                  ...
                  style={{
                    ...
                    border: showCwPanel ? '1.5px solid #685DBC' : '1.5px solid #C4B5FD',
                    background: showCwPanel ? '#685DBC' : '#F8F7FF',
                    color: showCwPanel ? '#fff' : '#685DBC',
                    ...
                    return (
                      <div key={a.id} style={{ display: 'flex', alignItems: 'flex-start', gap: 9, padding: '9px 12px', borderTop: '1px solid #FCEFD6', borderLeft: `3px solid ${warn ? '#F59E0B' : '#60A5FA'}` }}>
                        ...
                        <div style={{ flex: 1, minWidth: 0 }}>
                          ...
                          <div style={{ fontSize: 10.5, color: '#69707E', lineHeight: 1.5, marginTop: 1 }}>{a.detail}</div>
                        </div>
                        {a.fix && (
                          <button onClick={a.fix.run}
                            style={{ flexShrink: 0, fontSize: 10.5, fontWeight: 700, color: '#685DBC', background: '#fff', border: '1px solid #E9E3FF', borderRadius: 6, padding: '4px 9px', cursor: 'pointer', fontFamily: 'inherit', whiteSpace: 'nowrap' }}>
                            {a.fix.label}
                          </button>
                        )}
                      </div>
            ...
            {activeClassGroups.length > 1 && displayRows.length > 0 && (
              <div style={{ display: 'flex', gap: 6, flexWrap: 'wrap', marginBottom: 10, alignItems: 'center' }}>
                <span style={{ fontSize: 10, fontWeight: 700, color: '#6B7079', letterSpacing: '0.05em', marginRight: 2 }}>
                  VIEW
                </span>
                {/* All chip */}
                <button
                  ...
                  style={{
                    ...
                    background: bellViewFilter === 'all' ? '#685DBC' : '#F3F4F6',
                    color: bellViewFilter === 'all' ? '#fff' : '#69707E',
                    border: bellViewFilter === 'all' ? '1.5px solid #685DBC' : '1.5px solid #E5E7EB',
                    cursor: 'pointer', fontFamily: 'inherit', transition: 'all .12s',
                  }}>
                  All classes
                </button>
                ...
                {cycleWeeks > 1 && !useDayNames ? (
                  ...
                  <div>
                    <div style={{
                      ...
                      <div />
                      {ALL_DAYS.map(d => (
                        <div key={d} style={{ fontSize: 10, fontWeight: 700, color: '#6B7079', textAlign: 'center' }}>{d}</div>
                      ))}
                      {/* Week rows */}
                      {Array.from({ length: cycleWeeks }, (_, i) => {
                        const w = i + 1
                          ...
                          if (di === 0) {
                            nodes.push(
                              <div key={`lbl-w${w}`} style={{
                                fontSize: 10, fontWeight: 800, color: '#685DBC',
                                fontFamily: "'DM Mono',monospace",
                          ...
                          nodes.push(
                            <button key={k} onClick={() => isWorking && setActiveDayTab(k)}
                              ...
                              style={{
                                ...
                                color: isActive ? '#fff' : isWorking ? (isCustom ? '#685DBC' : '#374151') : '#D1D5DB',
                                border: isActive ? '1.5px solid #685DBC' : isWorking ? (isCustom ? '1px solid #C4B5FD' : '1px solid #E5E7EB') : '1px solid transparent',
                    ...
                    {activeDayTab && (
                      <div style={{ marginTop: 6, fontSize: 11, color: '#685DBC', fontWeight: 600 }}>
                      ...
                      {dayKeys.map(k => {
                        ...
                        return (
                          <button key={k} onClick={() => setActiveDayTab(k)} style={{
                            ...
                            color: activeDayTab === k ? '#685DBC' : isCustom ? '#685DBC' : '#69707E',
                            ...
                            {isCustom && activeDayTab !== k && (
                              <span style={{ position: 'absolute', top: 3, right: 3, width: 5, height: 5, borderRadius: '50%', background: '#685DBC' }} />
                            )}
                          </button>
                        )
                      })}
                    </div>
                    <span style={{ fontSize: 11, color: '#6B7079' }}>
            ...
            {varyByDay && dayKeys.length > 1 && (
              <div style={{
                ...
                <span style={{ fontSize: 11, fontWeight: 700, color: '#6B7079', letterSpacing: '0.05em' }}>COPY</span>
                <select
                ...
                <button
                  ...
                  style={{
                    padding: '4px 13px', borderRadius: 6, border: '1px solid #685DBC',
                    background: '#F5F3FF', color: '#685DBC', fontSize: 11, fontWeight: 700,
                    cursor: 'pointer', fontFamily: 'inherit',
                  }}>
                  Copy schedule →
                </button>
            ...
            {varyByDay && activeDayTab && (
              <div style={{
                ...
                <span style={{ fontSize: 11, fontWeight: 700, color: '#685DBC', flexShrink: 0, minWidth: 60 }}>
                  {activeDayTab.replace(/^w(\d+)-(.+)$/, 'Week $1 · $2')}
                </span>
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: 5 }}>
                  <span style={{ fontSize: 11, color: '#6B7079' }}>Starts</span>
                  <input type="time"
                    ...
                    style={{
                      ...
                      border: dayStartTimes[activeDayTab] ? '1.5px solid #685DBC' : '1px solid #DDD6FE',
                      color: dayStartTimes[activeDayTab] ? '#685DBC' : '#374151',
                  ...
                  {dayStartTimes[activeDayTab] && (
                    <button onClick={() => setDayStartTimes(prev => { const n = { ...prev }; delete n[activeDayTab]; return n })}
                      style={{ fontSize: 10, color: '#6B7079', background: 'none', border: 'none', cursor: 'pointer', padding: 0, fontFamily: 'inherit' }}>reset</button>
                  )}
                </div>
                ...
                {/* End time (derived) */}
                <div style={{ display: 'flex', alignItems: 'center', gap: 5 }}>
                  <span style={{ fontSize: 11, color: '#6B7079' }}>Ends</span>
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: 5 }}>
                  ...
                  <NumInput className="b-dur" value={activePeriodDur} min={10} max={240}
                    onChange={handlePeriodDurChange}
                    style={{
                      border: dayPeriodDurs[activeDayTab] ? '1.5px solid #685DBC' : '1px solid #DDD6FE',
                      color: dayPeriodDurs[activeDayTab] ? '#685DBC' : '#13111E',
                      fontWeight: dayPeriodDurs[activeDayTab] ? 700 : 400,
                    }} />
                  <span style={{ fontSize: 11, color: '#6B7079' }}>min</span>
                  <button onClick={applyDurToAll}
                    title="Set every period row to this duration"
                    style={{ fontSize: 10, color: '#685DBC', background: 'none', border: '1px solid #DDD6FE', borderRadius: 4, cursor: 'pointer', padding: '1px 6px', fontFamily: 'inherit', fontWeight: 600 }}>
                    Apply all
                  </button>
                  {dayPeriodDurs[activeDayTab] && (
            ...
            <div style={{ background: '#fff', borderRadius: 10, border: varyByDay ? '1.5px solid #DDD6FE' : '1px solid #E5E7EB' }}>
              ...
              {todayAttendance && (
                <div style={{
                  ...
                  <span style={{ fontSize: 11, fontWeight: 700, color: '#6B7079', letterSpacing: '0.05em', flexShrink: 0 }}>
                    ATTENDING TODAY
                  </span>
                      ...
                      <div className="b-row" style={{
                        ...
                        <NumInput className="b-dur" value={row.duration} min={5} max={240}
                          ...
                          style={row.type === 'teaching' && row.duration !== activePeriodDur
                            ? { border: '1.5px solid #685DBC', color: '#685DBC', fontWeight: 700 }
                            : undefined}
                        />
                        <select
                          value={row.type}
              ...
              <div style={{ padding: '10px 14px', display: 'flex', gap: 8, flexWrap: 'wrap', borderTop: '1px solid #F3F4F6', borderRadius: '0 0 10px 10px' }}>
                <button onClick={handleAISuggest} style={{
                  ...
                  border: '1px solid #C4B5FD', background: '#F5F3FF', fontSize: 12, fontWeight: 600, color: '#685DBC', cursor: 'pointer', fontFamily: 'inherit',
                }}>
                ...
                <button
                  ...
                  style={{ display: 'inline-flex', alignItems: 'center', gap: 5, padding: '6px 14px', borderRadius: 7, border: '1px solid #E5E7EB', background: '#fff', fontSize: 12, fontWeight: 600, color: '#69707E', cursor: 'pointer', fontFamily: 'inherit' }}>
                  Reset to default
                </button>
              </div>
            </div>
                ...
                return (
                  <div key={row.id + idx} style={{
                    ...
                    <div style={{ fontFamily: "'DM Mono',monospace", flexShrink: 0, minWidth: 58 }}>
                      ...
                      <div style={{ fontSize: 10, color: '#6B7079' }}>{fmt12(end, use12h)}</div>
                    </div>
                    <div style={{ flex: 1, minWidth: 0 }}>
                      <div style={{ fontSize: 12, fontWeight: 600, color: '#13111E' }}>{row.name}</div>
                      <div style={{ fontSize: 10, color: '#6B7079' }}>{row.duration} min · {grp}</div>
                    </div>
                  </div>
                )
              })}
              ...
              <div key={c.label} style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 8 }}>
                <div style={{ display: 'flex', alignItems: 'flex-start', gap: 7 }}>
                  ...
                  <div>
                    ...
                    <div style={{ fontSize: 10, color: '#6B7079' }}>{c.desc}</div>
                  </div>
                </div>
                <span style={{ fontSize: 13, fontWeight: 700, color: '#13111E' }}>
                  {c.count}<span style={{ fontSize: 11, fontWeight: 400, color: '#6B7079' }}> /wk</span>
                </span>
              </div>
            ))}
          </div>
          ...
          <div style={{
            ...
            <div style={{ display: 'flex', alignItems: 'flex-start', gap: 12, marginBottom: 16 }}>
              ...
              <div>
                ...
                <div style={{ fontSize: 13, color: '#69707E', lineHeight: 1.55 }}>
                  {confirmDialog.msg}
                </div>
              </div>
            </div>
...
function SH({ children }: { children: React.ReactNode }) {
  return (
    <div style={{ fontSize: 10, fontWeight: 700, letterSpacing: '0.09em', textTransform: 'uppercase', color: '#6B7079', marginBottom: 8 }}>
      {children}
    </div>
  )
}
const FL: CSSProperties = { fontSize: 12, color: '#69707E', marginBottom: 5 }
const FH: CSSProperties = { fontSize: 11, color: '#6B7079', marginTop: 3 }
